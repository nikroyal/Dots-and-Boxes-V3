...
export const ACHIEVEMENTS = [
  ...
  { id: 'social_butterfly', name: 'Social Butterfly', desc: 'Add 5 friends',
    check: s => (Array.isArray(s.friends) ? s.friends.length : typeof s.friends === "number" ? s.friends : 0) >= 5, progress: s => [Array.isArray(s.friends) ? s.friends.length : typeof s.friends === "number" ? s.friends : 0, 5] },
  ...
  { id: 'daily_goal_1',   name: 'First Step',     desc: 'Complete your first Daily Goal',
    check: s => (s.dailyGoalsCompleted || 0) >= 1, progress: s => [s.dailyGoalsCompleted || 0, 1] },
  { id: 'daily_goal_7',   name: 'Consistent',     desc: 'Complete 7 Daily Goals',
    check: s => (s.dailyGoalsCompleted || 0) >= 7, progress: s => [s.dailyGoalsCompleted || 0, 7] },
  { id: 'daily_goal_30',  name: 'Dedicated',      desc: 'Complete 30 Daily Goals',
    check: s => (s.dailyGoalsCompleted || 0) >= 30, progress: s => [s.dailyGoalsCompleted || 0, 30] },
  { id: 'streak_daily_3', name: 'Momentum',       desc: 'Reach a 3-day Daily Goal streak',
    check: s => (s.bestDailyGoalStreak || 0) >= 3, progress: s => [s.bestDailyGoalStreak || 0, 3] },
  { id: 'streak_daily_7', name: 'Habitual',       desc: 'Reach a 7-day Daily Goal streak',
    check: s => (s.bestDailyGoalStreak || 0) >= 7, progress: s => [s.bestDailyGoalStreak || 0, 7] },
  // ── Easter eggs ───────────────────────────────────────────────────────────
