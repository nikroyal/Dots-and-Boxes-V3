      ...
      <section className="grid gap-4 lg:grid-cols-[270px_1fr]">
        <aside className="space-y-3">
          ...
          <div className="card space-y-2">
            ...
            <div className="grid grid-cols-2 gap-2">
              <button onClick={undo} disabled={historyIndex <= 0} className="btn-ghost"><Undo2 size={13} aria-hidden="true" /> Undo</button>
              ...
              <button onClick={removeSelected} disabled={!selected.length} className="btn-ghost"><Trash2 size={13} aria-hidden="true" /> Delete</button>
            ...
            <button onClick={clear} className="btn-danger w-full"><Trash2 size={13} aria-hidden="true" /> Clear</button>
          </div>
