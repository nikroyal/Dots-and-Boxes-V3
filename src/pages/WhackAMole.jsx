...
export default function WhackAMole() {
  ...
  const endGame = useCallback(() => {
    ...
    if (finalScore > bestScore) {
      ...
      if (profile) recordActivity(profile, ACTIVITY_TYPES.ARCADE_BEST, { game: 'Whack-A-Mole', score: finalScore });
      if (profile) updateArcadeBest(profile, 'whack-a-mole', 'Whack-A-Mole', finalScore, finalScore.toString());
    }
  }, [bestScore, profile]);
