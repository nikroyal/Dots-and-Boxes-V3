...
// Optimization (Bolt): Memoize Chessboard to prevent expensive re-renders on every turn timer tick.
const MemoizedChessboard = memo(Chessboard);

// Optimization (Bolt): Move static styles outside the component to avoid hook overhead
