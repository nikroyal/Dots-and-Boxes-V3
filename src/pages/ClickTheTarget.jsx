  ...
  useEffect(() => {
    if (timeLeft <= 0 && gameState === 'playing') {
      ...
      if (score > bestScore) {
        ...
        if (profile) recordActivity(profile, ACTIVITY_TYPES.ARCADE_BEST, { game: 'Click The Target', score: score + ' targets' });
        if (profile) updateArcadeBest(profile, 'click-the-target', 'Click The Target', score, score + ' targets');
      } else {
        sfx.notify();
      }
    }
