            ...
            {settingsOpen && (
              <div id="settings-menu" className="absolute right-0 mt-2 w-56 border hairline z-40"
                ...
                <div className="p-3 space-y-3">
                  ...
                  <label htmlFor="reduced-motion" className="flex items-center justify-between gap-2 cursor-pointer">
                    <span className="font-mono text-[0.65rem] tracking-widest uppercase opacity-80">Reduced motion</span>
                    <input id="reduced-motion" type="checkbox" checked={motionState} onChange={toggleMotion}
