...
## 2024-05-18 - Dynamic Next-Tier Goals
**Learning:** Arcade games with score tiers create stronger replay hooks when they explicitly show "X points to next tier" rather than just a final rating or static goal.
**Action:** Always include live or next-tier progress indicators in score-based mini-games to trigger the "just one more run" response.
